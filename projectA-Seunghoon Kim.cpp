...
//		matrix[0][2] = 0;
//		matrix[1][0] = 0;
//		matrix[1][1] = cos(x_rot);
//		matrix[1][2] = -sin(x_rot);
//		matrix[2][0] = 0;
//		matrix[2][1] = sin(x_rot);
//		matrix[2][2] = cos(x_rot);
//		if (setModel.x_rot > 0.0)
//		{
 //           setModel.x_scale = setModel.matrix[0][0]*xpos;
  //          setModel.y_scale = setModel.matrix[1][1]*ypos + setModel.matrix[1][2]*zpos;
//            setModel.z_scale = setModel.matrix[2][1]*ypos + setModel.matrix[2][2]*zpos;
//		}
